...
| 34 | SNS management notification (optional bonus) | Architecture | **PASS** | `sns_notification.py` — non-blocking optional path | Not required for demo | `test_sns_management_notification.py` | None required | Frozen as optional; not a course blocker | R |
