...
sudo docker run -d \
  ...
  -e SCOUTMATCH_FOOTBALL_OPS_TABLE="${SCOUTMATCH_FOOTBALL_OPS_TABLE:-ScoutMatchRecruitmentShortlistAvidan}" \
  -e SCOUTMATCH_FOOTBALL_OPS_HASH_KEY="${SCOUTMATCH_FOOTBALL_OPS_HASH_KEY:-candidate_key}" \
  -e SCOUTMATCH_FOOTBALL_OPS_KEY_PREFIX="${SCOUTMATCH_FOOTBALL_OPS_KEY_PREFIX:-football_ops#}" \
  "${IMAGE_TAG}"
