...
CANDIDATE="${CANDIDATE:-scoutmatch-ai-v10-release-audit-candidate}"
RUNTIME="${RUNTIME:-/home/ubuntu/scoutmatch-ai-v10-release-audit-runtime}"
LOG_FILE="${LOG_FILE:-/tmp/strict_release_audit_v10.log}"
PROD_CONTAINER="scoutmatch-ai"

for old in scoutmatch-ai-v10-full-validation-candidate scoutmatch-ai-v10-release-audit-candidate scoutmatch-ai-v9-release-audit-candidate; do
